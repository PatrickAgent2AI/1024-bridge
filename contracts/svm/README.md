...
> **版本**: v1.4  
> **最后更新**: 2025-11-09  
> **开发状态**: ✅ TDD开发完成！61/71测试通过(86%)，所有核心功能已实现
...
```bash
# 部署到Devnet
./scripts/quick-deploy.sh devnet

# 部署到自定义测试网
export CUSTOM_RPC_URL="https://your-custom-rpc.com"
./scripts/quick-deploy.sh custom
```
...
**详细指南**: [DEPLOYMENT.md](./bridge-programs/DEPLOYMENT.md) | [scripts/README.md](./bridge-programs/scripts/README.md)
